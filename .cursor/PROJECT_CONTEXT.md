# โครงการ AI Camera — Context Engineering สำหรับ Cursor

เอกสารนี้สรุปบริบทโครงการจากที่ได้คุยและพัฒนาร่วมกัน เพื่อใช้เป็น **Context** และ **Rule** สำหรับ Cursor ในการพัฒนาต่อไป
...
การพัฒนาต่อ: อ่านเอกสารนี้ร่วมกับ `server/docs/DEVELOPER_HANDBOOK.md` และ rule ใน `.cursor/rules/` (โดยเฉพาะ server-new-stack.mdc) แล้วยึดหลักการด้านบนเป็นหลักในการแก้ไขหรือเพิ่มฟีเจอร์
