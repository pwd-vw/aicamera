...
show_usage() {
    ...
    echo ""
    echo "Commands:"
    echo "  start   - Start the kiosk browser service (manual start)"
    ...
    echo ""
    echo "Note: This service is designed to start automatically on boot."
    echo "Manual start is only needed for testing or immediate use."
    echo ""
    echo "Examples:"
    echo "  $0 start    # Start kiosk browser manually"
